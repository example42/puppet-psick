# psick::virtualbox::tp
#
# @summary This psick profile manages virtualbox with Tiny Puppet (tp)
#
# @example Include it to install virtualbox
...
#   Check psick::virtualbox::tp:resources_auto_conf_hash in data/$auto_conf/*.yaml for
...
#   Check psick::virtualbox::tp:options_auto_conf_hash in data/$auto_conf/*.yaml for
#   the auto_conf defaults.
