...
#   psick::puppetdb::install::options:
#     key: value
#
...
#   automatically added.
#   psick::puppetdb::install::auto_conf: true
#
...
#   Check psick::puppetdb::install::resources_auto_conf_hash in
...
#   Check psick::puppetdb::install::options_auto_conf_hash in
#   data/common/puppetdb.yaml for the auto_conf defaults.
#
...
#   parameter.
# @param resource_lookup_method What lookup method to use for psick::puppetdb::install::resources
...
#  Hash               $options                 = {},
  ...
  $options=lookup('psick::puppetdb::install::options', Hash, $options_lookup_method, {})
  ...
  if $manage {
    ...
    # Declaration of psick::puppetdb::install::resources
    $resources=lookup('psick::puppetdb::install::resources', Hash, $resources_lookup_method, {})
