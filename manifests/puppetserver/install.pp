...
#   psick::puppetserver::install::options:
#     key: value
#
...
#   automatically added.
#   psick::puppetserver::install::auto_conf: true
#
...
#   Check psick::puppetserver::install::resources_auto_conf_hash in
...
#   Check psick::puppetserver::install::options_auto_conf_hash in
#   data/common/puppetserver.yaml for the auto_conf defaults.
#
...
#   parameter.
# @param resource_lookup_method What lookup method to use for psick::puppetserver::install::resources
...
#
class psick::puppetserver::install (
...
#  Hash               $options                 = {},
  ...
  if $manage {
    ...
    # Declaration of psick::puppetserver::install::resources
    $resources=lookup('psick::puppetserver::install::resources', Hash, $resources_lookup_method, {})
