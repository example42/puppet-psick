...
# Use equivalent class tp_profile::rabbitmq in the tp_profile module as replacement
#
...
class psick::rabbitmq::tp (
  ...
  if $manage {
    notify { 'Deprecated profile psick::rabbitmq::tp':
      message => 'This profile has been deprecated. It will be removed on version 1.0.0 of psick module. Use equivalent class tp_profile::rabbitmq in the tp_profile     module as replacement',
    }
