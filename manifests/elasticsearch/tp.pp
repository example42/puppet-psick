...
# @param ensure If to install or remove elasticsearch
# @param resources_hash An hash of tp conf and dir resources for elasticsearch.
...
# @param settings_hash An hash of tp settings to customise elasticsearch file
...
# @param auto_conf If to automatically use default configurations for elasticsearch.
