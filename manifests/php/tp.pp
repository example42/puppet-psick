...
#
# @example Include it to install php
...
#   psick::php::tp::auto_conf: 'default'
#
...
# @param resources_hash An hash of tp::conf and tp::dir resources for php.
...
#   Check psick::php::tp:resources_auto_conf_hash in data/$auto_conf/*.yaml for
...
#   Check psick::php::tp:options_auto_conf_hash in data/$auto_conf/*.yaml for
#   the auto_conf defaults.
