...
#   automatically added.
#   psick::php::install::auto_conf: true
#
...
#   parameter.
# @param resource_lookup_method What lookup method to use for psick::php::install::resources
...
#  Hash               $options                 = {},
  ...
  $options=lookup('psick::php::install::options', Hash, $options_lookup_method, {})
  ...
  if $manage {
    ...
    # Declaration of psick::php::install::resources
    $resources=lookup('psick::php::install::resources', Hash, $resources_lookup_method, {})
