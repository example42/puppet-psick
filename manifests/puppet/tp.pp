# psick::puppet::tp
#
# @summary This psick profile manages puppet with Tiny Puppet (tp)
#
# @example Include it to install puppet
...
# @param ensure If to install or remove puppet. Valid values are present, absent, latest
#   or any version string, matching the expected puppet package version.
# @param resources_hash An hash of tp::conf and tp::dir resources for puppet.
...
#   Check psick::puppet::tp:resources_auto_conf_hash in data/$auto_conf/*.yaml for
...
#   Check psick::puppet::tp:options_auto_conf_hash in data/$auto_conf/*.yaml for
#   the auto_conf defaults.
# @param settings_hash An hash of tp settings to override default puppet file
...
# @param auto_prereq If to automatically install eventual dependencies for puppet.
#   Set to false if you have problems with duplicated resources, being sure that you
#   manage the prerequistes to install puppet (other packages, repos or tp installs).
