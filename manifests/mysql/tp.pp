...
# @param resources_hash An hash of tp conf and dir resources for mysql.
...
# @param settings_hash An hash of tp settings to customise mysql file
...
# @param auto_conf If to automatically use default configurations for mysql.
