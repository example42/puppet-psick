# psick::mysql::install
#
# @summary This class manages mysql with Tiny Puppet (tp)
#
# When you include this class the relevant tp::install define is declared
# which is expected to install mysql package and manage its service.
# Via the resources_hash parameter is possible to pass hashes of tp::conf and
# tp::dir defines which can manage mysql configuration files and
# whole dirs.
...
#     exec:
#       mysql::setup:
#         command: '/usr/local/bin/mysql_setup'
#         creates: '/opt/mysql'
#   psick::mysql::install::options:
#     key: value
#
...
#   automatically added.
#   psick::mysql::install::auto_conf: true
#
...
#
# @param auto_conf If to enable automatic configuration of mysql based on the
#   resources_auto_conf_hash and options_auto_conf_hash parameters, if present in
#   data/common/mysql.yaml. You can both override them in your Hiera files
...
#   Check psick::mysql::install::resources_auto_conf_hash in
#   data/common/mysql.yaml for the auto_conf defaults.
# @param options_auto_conf_hash The default options hash if auto_conf is set.
#   Check psick::mysql::install::options_auto_conf_hash in
#   data/common/mysql.yaml for the auto_conf defaults.
#
# @param resources An hash of any resource, like tp::conf, tp::dir, exec or whatever
#   to declare for mysql confiuration. Can also come from a third-party
#   component modules with dedicated mysql resources.
...
#   parameter.
# @param resource_lookup_method What lookup method to use for psick::mysql::install::resources
...
#  Hash               $options                 = {},
  ...
  $options=lookup('psick::mysql::install::options', Hash, $options_lookup_method, {})
  ...
  if $manage {
    ...
    # Declaration of psick::mysql::install::resources
    $resources=lookup('psick::mysql::install::resources', Hash, $resources_lookup_method, {})
