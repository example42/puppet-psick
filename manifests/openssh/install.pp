...
#   automatically added.
#   psick::openssh::install::auto_conf: true
#
...
#   Check psick::openssh::install::resources_auto_conf_hash in
...
#   Check psick::openssh::install::options_auto_conf_hash in
#   data/common/openssh.yaml for the auto_conf defaults.
#
...
#   parameter.
# @param resource_lookup_method What lookup method to use for psick::openssh::install::resources
...
#  Hash               $options                 = {},
  ...
  $options=lookup('psick::openssh::install::options', Hash, $options_lookup_method, {})
  ...
  if $manage {
    ...
    # Declaration of psick::openssh::install::resources
    $resources=lookup('psick::openssh::install::resources', Hash, $resources_lookup_method, {})
