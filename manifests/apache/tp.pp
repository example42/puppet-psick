...
#
# @example Include it to install apache
...
#   psick::apache::tp::auto_conf: 'default'
#
...
# @param resources_hash An hash of tp::conf and tp::dir resources for apache.
...
#   Check psick::apache::tp:resources_auto_conf_hash in data/$auto_conf/*.yaml for
...
#   Check psick::apache::tp:options_auto_conf_hash in data/$auto_conf/*.yaml for
#   the auto_conf defaults.
