...
# @param resources_hash An hash of tp conf and dir resources for apache.
...
# @param settings_hash An hash of tp settings to customise apache file
...
# @param auto_conf If to automatically use default configurations for apache.
