# psick::apache::install
#
# @summary This class manages apache with Tiny Puppet (tp)
#
...
#   automatically added.
#   psick::apache::install::auto_conf: true
#
...
#   Check psick::apache::install::resources_auto_conf_hash in
...
#   Check psick::apache::install::options_auto_conf_hash in
#   data/common/apache.yaml for the auto_conf defaults.
#
...
#   parameter.
# @param resource_lookup_method What lookup method to use for psick::apache::install::resources
...
#  Hash               $options                 = {},
  ...
  if $manage {
    ...
    # Declaration of psick::apache::install::resources
    $resources=lookup('psick::apache::install::resources', Hash, $resources_lookup_method, {})
