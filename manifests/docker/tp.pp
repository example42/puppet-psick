...
# Use equivalent class tp_profile::docker in the tp_profile module as replacement
# psick::docker::tp
#
...
class psick::docker::tp (
  ...
  if $manage {
    notify { 'Deprecated profile psick::docker::tp':
      message => 'This profile has been deprecated. It will be removed on version 1.0.0 of psick module. Use equivalent class tp_profile::docker in the tp_profile module as replacement',
    }
