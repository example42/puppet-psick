...
# triggers a reboot (once). Set psick::firstrun::linux::reboot to false
# to avoid it.
#
# @example Enable firstrun and configure it to set hostname and reboot
#   firstrun_enable: true
#   psick::firstrun::linux::hostname_class: psick::hostname
#
...
#   firstrun_enable: true
#   psick::firstrun::linux::hostname_class: psick::hostname
#   psick::firstrun::linux::proxy_class: psick::proxy
#   psick::firstrun::linux::reboot: false
#
