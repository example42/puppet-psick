...
# triggers a reboot (once). Set psick::firstrun::windows::reboot to false
# to avoid it.
#
# @example Enable firstrun and configure it to set hostname and reboot
#   firstrun_enable: true
#   psick::firstrun::windows::hostname_class: psick::hostname
#
...
#   firstrun_enable: true
#   psick::firstrun::windows::hostname_class: psick::hostname
#   psick::firstrun::windows::proxy_class: psick::proxy
#   psick::firstrun::windows::reboot: false
#
# @example Never include this psick and have a normal Puppet run, based
#   on psick::pre, psick::base and the classes defined in the psicks key
...
#   any effect of the firstrun psick.
