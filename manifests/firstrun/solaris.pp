...
# triggers a reboot (once). Set psick::firstrun::solaris::reboot to false
# to avoid it.
#
# @example Enable firstrun and configure it to set hostname and reboot
#   firstrun_enable: true
#   psick::firstrun::solaris::hostname_class: psick::hostname
#
...
#   firstrun_enable: true
#   psick::firstrun::solaris::hostname_class: psick::hostname
#   psick::firstrun::solaris::proxy_class: psick::proxy
#   psick::firstrun::solaris::reboot: false
#
