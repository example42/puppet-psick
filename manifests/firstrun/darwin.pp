...
# triggers a reboot (once). Set psick::firstrun::darwin::reboot to false
# to avoid it.
#
# @example Enable firstrun and configure it to set hostname and reboot
#   firstrun_enable: true
#   psick::firstrun::darwin::hostname_class: psick::hostname
#
...
#   firstrun_enable: true
#   psick::firstrun::darwin::hostname_class: psick::hostname
#   psick::firstrun::darwin::proxy_class: psick::proxy
#   psick::firstrun::darwin::reboot: false
#
