...
# @param resources_hash An hash of tp conf and dir resources for mariadb.
...
# @param settings_hash An hash of tp settings to customise mariadb file
...
# @param auto_conf If to automatically use default configurations for mariadb.
