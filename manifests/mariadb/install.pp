...
#   automatically added.
#   psick::mariadb::install::auto_conf: true
#
...
#   Check psick::mariadb::install::resources_auto_conf_hash in
...
#   Check psick::mariadb::install::options_auto_conf_hash in
#   data/common/mariadb.yaml for the auto_conf defaults.
#
...
#   parameter.
# @param resource_lookup_method What lookup method to use for psick::mariadb::install::resources
...
#  Hash               $options                 = {},
  ...
  $options=lookup('psick::mariadb::install::options', Hash, $options_lookup_method, {})
  ...
  if $manage {
    ...
    # Declaration of psick::mariadb::install::resources
    $resources=lookup('psick::mariadb::install::resources', Hash, $resources_lookup_method, {})
