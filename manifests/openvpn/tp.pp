...
# Use equivalent class tp_profile::openvpn in the tp_profile module as replacement
# psick::openvpn::tp
#
...
class psick::openvpn::tp (
  ...
  if $manage {
    notify { 'Deprecated profile psick::openvpn::tp':
      message => 'This profile has been deprecated. It will be removed on version 1.0.0 of psick module. Use equivalent class tp_profile::openvpn in the tp_profile module as replacement',
    }
