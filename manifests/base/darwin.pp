# The base psick profile included on all darwin systems.
#
...
#   psick::base::darwin::puppet_class: '::puppet'
#   psick::base::darwin::users_class: '::psick::users::static'
#
# @example Completely disable management of any resource from this class
#   psick::base::darwin::manage: false
#
