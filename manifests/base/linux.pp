# The base psick profile included on all linux systems.
# 
...
#   psick::base::linux::puppet_class: '::puppet'
#   psick::base::linux::users_class: '::psick::users::static'
#
# @example Completely disable management of any resource from this class
#   psick::base::linux::manage: false
#
