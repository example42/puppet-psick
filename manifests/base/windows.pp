# The base psick profile included on all Windows systems.
#
...
#   psick::base::windows::puppet_class: '::puppet'
#   psick::base::windows::users_class: '::psick::users::static'
#
# @example Completely disable management of any resource from this class
#   psick::base::windows::manage: false
#
