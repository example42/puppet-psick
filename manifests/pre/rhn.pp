...
#   psick::pre::rhn::redhat: 'http://10.1.4.20/XMLRPC'
#   psick::pre::rhn::oracle: 'http://10.1.4.23/XMLRPC'
#   psick::pre::rhn::sles: 'http://10.1.4.21/XMLRPC'
#
class psick::pre::rhn (
  ...
  $real_rhn_server_url = $rhn_server_url ? {
    ''    => $::operatingsystem ? {
      'RedHat'      => hiera('psick::pre::rhn::redhat',''),
      'OracleLinux' => hiera('psick::pre::rhn::oracle',''),
      'SLES'        => hiera('psick::pre::rhn::sles',''),
      default       => '',
    },
