...
# @param resources_hash An hash of tp conf and dir resources for foreman.
...
# @param settings_hash An hash of tp settings to customise foreman file
...
# @param auto_conf If to automatically use default configurations for foreman.
