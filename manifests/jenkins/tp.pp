...
# Use equivalent class tp_profile::jenkins in the tp_profile module as replacement
# psick::jenkins::tp
#
# @summary This psick profile manages jenkins with Tiny Puppet (tp)
#
# @example Include it to install jenkins
#   include psick::jenkins::tp
#
# @example Include in PSICK via hiera (yaml)
#   psick::profiles::linux_classes:
#     jenkins: psick::jenkins::tp
#
# @example Manage extra configs via hiera (yaml) with templates based on custom options
#   psick::jenkins::tp::ensure: present
#   psick::jenkins::tp::resources_hash:
#     tp::conf:
#       jenkins:
#         epp: profile/jenkins/jenkins.conf.epp
#       jenkins::dot.conf:
#         epp: profile/jenkins/dot.conf.epp
#         base_dir: conf
#   psick::jenkins::tp::options_hash:
#     key: value
#
...
#   psick::jenkins::tp::auto_conf: 'default'
#
# @param manage If to actually manage any resource in this profile or not
# @param ensure If to install or remove jenkins. Valid values are present, absent, latest
#   or any version string, matching the expected jenkins package version.
# @param resources_hash An hash of tp::conf and tp::dir resources for jenkins.
...
#   Check psick::jenkins::tp:resources_auto_conf_hash in data/$auto_conf/*.yaml for
...
#   Check psick::jenkins::tp:options_auto_conf_hash in data/$auto_conf/*.yaml for
#   the auto_conf defaults.
# @param settings_hash An hash of tp settings to override default jenkins file
...
# @param auto_prereq If to automatically install eventual dependencies for jenkins.
#   Set to false if you have problems with duplicated resources, being sure that you
#   manage the prerequistes to install jenkins (other packages, repos or tp installs).
...
class psick::jenkins::tp (
  ...
  if $manage {
    notify { 'Deprecated profile psick::jenkins::tp':
      message => 'This profile has been deprecated. It will be removed on version 1.0.0 of psick module. Use equivalent class tp_profile::jenkins in the tp_profile module as replacement',
    }
